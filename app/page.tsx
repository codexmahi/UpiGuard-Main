...
export default function Home() {
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground leading-tight">
                Real-time <span className="text-primary">Fraud Protection</span> for UPI Transactions
              </h1>
              <p className="text-lg text-muted-foreground max-w-2xl">
                Protect your digital payments with enterprise-grade machine learning. Detect and prevent fraud in real-time across all transaction types.
              </p>
            </div>
      ...
      {/* Features Section */}
      <section id="features" className="px-4 sm:px-6 lg:px-8 py-20 bg-secondary/5 border-t border-border">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Our multi-layered approach combines multiple detection methods to catch fraud before it happens
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Process transactions in milliseconds with our lightning-fast ML models'
              },
              {
                icon: BarChart3,
                title: 'Pattern Recognition',
                description: 'Identify suspicious behavior patterns across millions of transactions'
              },
              {
                icon: Lock,
                title: 'Device Fingerprinting',
                description: 'Track device signatures to detect account takeovers and unauthorized access'
              },
              {
                icon: TrendingUp,
                title: 'Behavioral Analytics',
                description: 'Learn user patterns and flag deviations from normal activity'
              },
              {
                icon: Smartphone,
                title: 'Multi-Channel Detection',
                description: 'Protect transactions across mobile, web, ATM, and in-store channels'
              },
              {
                icon: Users,
                title: 'Network Analysis',
                description: 'Detect fraud rings and coordinated attacks across multiple accounts'
              }
            ].map((feature, index) => (
            ...
            {[
              {
                ...
                description: 'User initiates a UPI payment with transaction details'
              },
              {
                number: '02',
                title: 'Data Collection',
                description: 'System collects device, network, and user behavior data'
              },
              {
                number: '03',
                title: 'ML Analysis',
                description: 'Multiple models analyze the transaction against fraud patterns'
              },
              {
                number: '04',
                title: 'Decision & Alert',
                description: 'Real-time decision with risk score and automated response'
              }
            ].map((step, index) => (
          ...
          <Card className="p-8 border-primary/20">
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="p-6 bg-primary/5 rounded-lg border border-primary/10">
                <div className="text-sm text-muted-foreground mb-2">Transactions Analyzed</div>
              ...
              <div className="p-6 bg-accent/5 rounded-lg border border-accent/10">
                <div className="text-sm text-muted-foreground mb-2">Fraud Detected</div>
                <div className="text-3xl font-bold text-foreground">18.2K</div>
                <div className="text-xs text-accent mt-2">₹4.2Cr prevented</div>
              </div>
              <div className="p-6 bg-primary/5 rounded-lg border border-primary/10">
                <div className="text-sm text-muted-foreground mb-2">Detection Accuracy</div>
                <div className="text-3xl font-bold text-foreground">99.8%</div>
                <div className="text-xs text-green-500 mt-2">False positive: 0.1%</div>
              </div>
            </div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-20 bg-gradient-to-r from-primary to-secondary">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
            Join thousands of fintech companies using UPIGuard to prevent fraud and protect their customers
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" asChild className="bg-primary-foreground text-primary hover:bg-primary-foreground/90 gap-2">
              <a href="https://upiguard-eta.vercel.app/" target="_blank" rel="noopener noreferrer">
                Try Free Demo
                <ArrowRight className="w-4 h-4" />
              </a>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Enterprise-grade fraud detection for UPI payments</p>
            </div>
            <div>
          ...
          <div className="border-t border-border pt-8 flex flex-col sm:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">© 2024 UPIGuard. All rights reserved.</p>
